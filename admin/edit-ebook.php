...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-ebook.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  ...
                                  <embed src="<?php echo $data['file_ebook']; ?>" alt="File Pdf" style="margin-bottom: 10px;" /><br />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                              <img src="sampul_ebook/<?php echo $data['gambar_ebook']; ?>" height="150" width="150" class="img-circle" style="border: 3px solid black;"/>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-4">
	                              ...
	                              <a href="ebook.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                      </form>
                                </div>
