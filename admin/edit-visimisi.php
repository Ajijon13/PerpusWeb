                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Edit Visi & Misi</center></b>

                                </header>
                                <!-- <div class="box-header"> -->
                                    <!-- <h3 class="box-title">Responsive Hover Table</h3> -->
                    <?php
                    $query = mysql_query("SELECT * FROM visimisi WHERE id='$_GET[kd]'");
                    $data  = mysql_fetch_array($query);
                    ?>
                                <!-- </div> -->
                      <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-visimisi.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                              <textarea name="visi" id="visi" style="height:300px" class="form-control"autocomplete="off"  required=""><?php echo $data['visi']; ?></textarea>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    <textarea name="misi" id="misi" style="height:300px" class="form-control"autocomplete="off" required=""><?php echo $data['misi']; ?></textarea>
                              </div>
                          </div>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-6">
	                              ...
	                              <a href="visimisi.php" class="btn btn-sm btn-danger">Batal </a>
