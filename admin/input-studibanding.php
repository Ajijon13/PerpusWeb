...
<?php } ?>
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Input Studi Banding</center></b>

                      </header>
                      <div class="panel-body">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="upload-studibanding.php" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kunjungan</label>
                              <div class="col-sm-2">
                              <select name="kunjungan" type="text" class="form-control" autocomplete="off" placeholder="Kategori" required="">
                            ...
                            <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Pilih Gambar</label>
                              <div class="col-sm-8">
                            ...
                            <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="studibanding.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                            </div>
                        </form>
                                </div>
        ...
        <!-- ckeditor-->
        <script src="assets/css/ckeditor/ckeditor.js" type="text/javascript" ></script>
        <!-- datepicker
