                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Input Tata Tertib</center></b>

                      </header>
                      <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="upload-tatatertib.php" method="POST" enctype="multipart/form-data">
                        
                        <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tata Tertib</label>
                              <div class="col-sm-6">
                              <textarea name="t_tertib" style="height:300px" class="form-control"autocomplete="off" placeholder="" required=""></textarea>
                              </div>
                          </div>
