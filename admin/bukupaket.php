...
<?php } ?>
                ...
                &nbsp; <a href="bukupaket.php" class="btn btn-sm btn-warning">Refresh Buku</a> <a href="input-buku.php" class="btn btn-sm btn-success">Tambah Buku</a>
                </div>
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>File Pdf</center></th>
                        <th><center>Gambar Sampul</center></th>
                    ...
                    <td><?php echo $data['file_buku'];?></td>
                    <td><center><img src="sampul_buku/<?php echo $data['gambar_buku']; ?>"  height="100" width="100" style="border: 1px solid #333333;" /></center></td>
                    <td><center><div id="thanks"><a class="btn btn-sm btn-primary" data-placement="bottom" data-toggle="tooltip" title="Edit E-Book" href="edit-buku.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-edit"></span></a>
                    <a onclick="return confirm ('Anda Yakin Menghapus Data <?php echo $data['judul'];?>.?');" class="btn btn-sm btn-danger tooltips" data-placement="bottom" data-toggle="tooltip" title="Hapus E-Book" href="hapus-buku.php?hal=hapus&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash"></a></center></td></tr></div>
              ...
              ?>
                  ...
                  <?php $tampil=mysql_query("select * from buku_paket order by id");
                    ...
                    ?>
                  <center><h4>Jumlah Buku : <?php echo "$buku"; ?> Eksemplar </h4> </center>
