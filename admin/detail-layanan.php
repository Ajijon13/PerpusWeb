...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Detail layanan</center></b>
                    ...
                    <table id="example" class="table table-hover table-bordered">
                        <tr>
                        <td>Id</td>
                        <td type="hidden"><?php echo $tampil['id']; ?></td>
                        <td rowspan="9"><div class="pull-right image">
                        <img src="gambar/<?php echo $tampil['g_layanan']; ?>"  height="300" width="250" alt="gambar" style="border: 3px solid #333333;" />
                        </div>
                        </td>
                        </tr>
                        <tr>
                        <td width="250">Keterangan</td>
                        <td width="550"><?php echo $tampil['keterangan']; ?></td>
                        </tr>
                    </table>
                   <div class="text-right">
                        <a href="layanan.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                    </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
