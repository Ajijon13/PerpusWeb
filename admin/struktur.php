...
?>
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel">
                            ...
                            <div class="text-left" style="margin-top: 10px;">
                                &nbsp; <a href="struktur.php" class="btn btn-sm btn-warning">Refresh</a>
                                <a href="#" class="btn btn-sm btn-success" data-toggle="modal"
                                    data-target="#modal_tambah_struktur">Input Data</a>
                            </div>

                            <!-- Modal -->
                            <div id="modal_tambah_struktur" class="modal fade" role="dialog">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal style-form" style="margin-top: 20px;"
                                                ...
                                                <div class="form-group" style="margin-bottom: 20px;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <button id="button_tambah_struktur" type="submit"
                    ...
                    { ?>
                                    <tbody>
                                        <tr>
                                            <td><a href="detail-struktur.php?hal=edit&kd=<?php echo $data['id'];?>"><span
                                                        class="fa fa-book"></span>
                                                    <?php echo $data['keterangan']; ?></a>
                                            </td>
                                            <td>
                                                <center><img src="gambar/<?php echo $data['gambar']; ?>" height="100"
                                                ...
                                                <center>
                                                    <div id="thanks">
                                                        ...
                                                        <a class="delete-link" data-placement="bottom"
                                                            ...
                                                            href="hapus-struktur.php?hal=hapus&kd=<?php echo $data['id'];?>"
              ...
              ?>
                            ...
                            <?php $tampil=mysql_query("select * from struktur order by id");
                                $struktur=mysql_num_rows($tampil);
                            ?>
                            <center>
                                <h4>Jumlah Data : <?php echo "$struktur"; ?> </h4>
                            </center>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <img id="edit-gambar" height="150" width="150" class="img-circle"
    ...
    <script>
        //tambah kode script
        //modal tambah 
        $("#form_tambah_struktur").submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "sukses") {
                        ...
                        $('#edit-gambar').attr("src","gambar/" + data.data.gambar);
        ...
        //modal edit save 
        $("#form_edit_struktur").submit(function (event) {
            event.preventDefault();
            var formData = new FormData(this);
            console.log(formData);
