...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <img src="gambar_berita/<?php echo $data['gambar_berita']; ?>"  height="300" width="250" alt="gambar" style="border: 2px solid #333333;" />
                    </div>
                    </td>
                    </tr>
                    <tr>
                ...
                <a href="berita.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
