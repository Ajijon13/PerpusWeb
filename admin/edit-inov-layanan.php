                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Edit Inovasi Layanan</b>
                                </header>
                    <?php
                    $query = mysql_query("SELECT * FROM inov_layanan WHERE id='$_GET[kd]'");
                    $data  = mysql_fetch_array($query);
                    ?>
                        <div class="panel-body">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-inov-layanan.php" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                              <img src="gambar/<?php echo $data['g_inovasi'];?>" height="150" width="150" class="img-circle" style="border: 3px solid darkblue;"/>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input-inov-layanan.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
