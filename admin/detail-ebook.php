...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Detail E-Book</center></b>

                                </header>
                    <?php

                    $query= mysql_query("SELECT * FROM data_ebook WHERE id='$_GET[kd]'");
                    $tampil  = mysql_fetch_array($query);
                    ?>
                    <div class="panel-body">
                    <table id="example" class="table table-hover table-bordered">
                    <tr>
                    <td rowspan="8"><div class="pull-right image">
                    <img src="sampul_ebook/<?php echo $tampil['gambar_ebook']; ?>"  height="300" width="250" alt="gambar" style="border: 2px solid #333333;" />
                    </div>
                    </td>
                    </tr>
                    <tr>
                    <td width="250">Judul</td>
                    <td width="550"><?php echo $tampil['judul']; ?></td>
                    </tr>
                    <td>Pengarang</td>
                    <td><?php echo $tampil['pengarang']; ?></td>
                    </tr>
                    <tr>
                    <td>Penerbit Dan Tempat Terbit</td>
                    <td><?php echo $tampil['tempatdanpenerbit']; ?></td>
                    </tr>
                    <tr>
                    <td>Isbn</td>
                    ...
                    <td><?php echo $tampil['jumlahhalaman']; ?></td>
                    </tr>
                    <tr>
                    <td>Kategori</td>
                    ...
                    <tr>
                    <td>File Pdf</td>
                    <td><?php echo $tampil['file_ebook']; ?></td>
                    </tr>
                   </table>
                  
                <div class="text-right">
                <a href="ebook.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
