...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Detail Visi & Misi</center></b>
                    ...
                    ?>
                      ...
                      <form class="form-horizontal style-form" style="margin-top: 20px;" enctype="multipart/form-data">
                      <div class="form-group">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Visi</label>
                              <div class="col-sm-6">
                              <textarea style="height:300px"  class="form-control"autocomplete="off"  required=""><?php echo $tampil['visi']; ?></textarea>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                    <textarea style="height:300px" class="form-control"autocomplete="off" required=""><?php echo $tampil['misi']; ?></textarea>
                              </div>
                          </div>
                            <div class="text-right">
                                <a href="visimisi.php" class="btn btn-sm btn-warning">Kembali <i class="fa fa-arrow-circle-right"></i></a>
                            </div>  
                      </form>
                                </div>
                            </div><!-- /.box -->
