...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <table id="example" class="table table-hover table-bordered">
                        ...
                        <img src="gambar/<?php echo $data['gambar_prestasi']; ?>"  height="300" width="250" alt="gambar" style="border: 3px solid #333333;" />
                        </div>
                        </td>
                        </tr>
                   </table>
                ...
                <a href="prestasi.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
