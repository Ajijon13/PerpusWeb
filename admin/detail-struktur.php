...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Detail Struktur Organisasi</b>
                    ...
                    <img src="gambar/<?php echo $data['gambar']; ?>"  height="300" width="250" alt="gambar" style="border: 3px solid #333333;" />
                    </div>
                    </td>
                    </tr>
                    <tr>
                ...
                <a href="struktur.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
