...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <img src="gambar/<?php echo $data['g_inovasi']; ?>"  height="300" width="250" alt="gambar" style="border: 3px solid #333333;" />
                    </div>
                    </td>
                    </tr>
                    <tr>
                ...
                <a href="inov-layanan.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
