                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b>Edit Berita Kegiatan</b>
                                </header>
                    <?php
                    $query = mysql_query("SELECT * FROM berita WHERE id='$_GET[kd]'");
                    $data  = mysql_fetch_array($query);
                    ?>
                        <div class="panel-body">
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-berita.php" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                              <img src="gambar/<?php echo $data['gambar_berita'];?>" height="150" width="150" class="img-circle" style="border: 3px solid darkblue;"/>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input-berita.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
