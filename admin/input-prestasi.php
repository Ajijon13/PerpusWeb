                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Input Prestasi</center></b>

                                </header>
                                <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="upload-prestasi.php" method="post" enctype="multipart/form-data">
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="prestasi.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
