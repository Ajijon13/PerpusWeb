...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <img src="sampul_buku/<?php echo $tampil['gambar_buku']; ?>"  height="300" width="250" alt="gambar" style="border: 2px solid #333333;" />
                    </div>
                    </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                    <td>File Pdf</td>
                    <td><?php echo $tampil['file_buku']; ?></td>
                    </tr>
                   </table>
                  
                <div class="text-right">
                <a href="bukupaket.php" class="btn btn-sm btn-warning"> Kembali <i class="fa fa-arrow-circle-right"></i></a>
                </div>  
                                </div>
                            </div><!-- /.box -->
                        </div>
