...
?>
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel">
                            ...
                            <div class="text-left" style="margin-top: 10px;">
                                &nbsp; <a href="layanan.php" class="btn btn-sm btn-warning">Refresh</a>  
                                <a href="#" class="btn btn-sm btn-success" data-toggle="modal"
                                    data-target="#modal_tambah_layanan">Tambah Data</a>
                            </div>

                            <!-- Modal -->
                            <div id="modal_tambah_layanan" class="modal fade" role="dialog">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal style-form" style="margin-top: 20px;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input name="g_layanan" type="file" accept="image/*"/>
                                                    </div>
                                                </div>
                    ...
                    { ?>
                                        <tr>
                                            <td><a href="detail-layanan.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="fa fa-book"></span> <?php echo $data['keterangan']; ?></a>
                                            </td>
                                            <td>
                                                <center><img src="gambar_inovasi/<?php echo $data['g_layanan']; ?>" height="100" width="100" style="border: 1px solid #333333;" />
                                                </center>
                                            </td>
                                            <td>
                                                <center>
                                                    ...
                                                    <a  class="delete-link" 
                                                        data-placement="bottom" 
                                                        title="Hapus Data"
                                                        href="hapus-layanan.php?hal=hapus&kd=<?php echo $data['id'];?>" data-placement="bottom">
              ...
              ?>
                            ...
                            <?php $tampil=mysql_query("select * from layanan order by id");
                                $layanan=mysql_num_rows($tampil);
                            ?>
                            <center>
                                <h4>Jumlah Layanan : <?php echo "$layanan"; ?> Data </h4>
                            </center>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <img id="edit-g_layanan" height="150" width="150" class="img-circle"
    ...
    <script>
            //tambah kode script
            //modal tambah 
            $("#form_tambah_layanan").submit(function (event) {
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data.status == "sukses"){
                            ...
                            $('#edit-g_layanan').attr("src","gambar_inovasi/" + data.data.g_layanan);
            ...
            $("#form_edit_layanan").submit(function (event) {
                event.preventDefault();
                var formData = new FormData(this);
                console.log(formData);
