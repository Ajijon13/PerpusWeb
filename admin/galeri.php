...
?>
        ...
        <aside class="right-side">
            ...
            <section class="content">
                ...
                <div class="row">
                        ...
                        <div class="panel">
                            ...
                            <div class="text-left" style="margin-top: 10px;">
                                ...
                                <a href="#" class="btn btn-sm btn-success" data-toggle="modal"
                                    data-target="#modal_tambah_galeri">Tambah Galeri</a>
                            </div>

                            <!-- Modal -->
                            <div id="modal_tambah_galeri" class="modal fade" role="dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form class="form-horizontal style-form" style="margin-top: 20px;"
                                                id="form_tambah_galeri">

                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label text-right">Pilih Gambar</label>
                                                    <div class="col-sm-8">
                                                        <input name="gambar_galeri" type="file" accept="image/*"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="margin-bottom: 20px;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <button id="button_tambah_galeri" type="submit"
                    ...
                    { ?>
                                        <tr>
                                            <td><a href="detail-galeri.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="fa fa-book"></span> <?php echo $data['keterangan']; ?></a>
                                            </td>
                                            <td>
                                                <center><img src="gambar_galeri/<?php echo $data['gambar_galeri']; ?>" height="100" width="100" style="border: 1px solid #333333;" />
                                                </center>
                                            </td>
                                            <td>
                                                <center>
                                                    ...
                                                    <a  class="delete-link" 
                                                        data-placement="bottom" 
                                                        title="Hapus Galeri"
                                                        href="hapus-galeri.php?hal=hapus&kd=<?php echo $data['id'];?>" data-placement="bottom">
              ...
              ?>
                            ...
                            <?php $tampil=mysql_query("select * from galeri order by id");
                                $galeri=mysql_num_rows($tampil);
                            ?>
                            <center>
                                <h4>Jumlah Galeri : <?php echo "$galeri"; ?> Data </h4>
                            </center>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <img id="edit-gambar_galeri" height="150" width="150" class="img-circle"
    ...
    <script>
            //tambah kode script
            //modal tambah berita
            $("#form_tambah_galeri").submit(function (event) {
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(data.status == "sukses"){
                            ...
                            $('#edit-gambar_galeri').attr("src","gambar_galeri/" + data.data.gambar_galeri);
            ...
            $("#form_edit_galeri").submit(function (event) {
                event.preventDefault();
                var formData = new FormData(this);
                console.log(formData);
