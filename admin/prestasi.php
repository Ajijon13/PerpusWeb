...
?>
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="panel">
                            ...
                            <div class="text-left" style="margin-top: 10px;">
                                &nbsp; <a href="prestasi.php" class="btn btn-sm btn-warning">Refresh</a>
                                <a href="#" class="btn btn-sm btn-success" data-toggle="modal"
                                    data-target="#modal_tambah_prestasi">Input Data</a>
                            </div>

                            <!-- Modal -->
                            <div id="modal_tambah_prestasi" class="modal fade" role="dialog">
                                            ...
                                            <form class="form-horizontal style-form" style="margin-top: 20px;"
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label text-right">Pilih
                                                        Gambar</label>
                                                    <div class="col-sm-8">
                                                        <input name="gambar_prestasi" type="file" accept="image/*" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group" style="margin-bottom: 20px;">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <button id="button_tambah_prestasi" type="submit"
                    ...
                    { ?>
                                    <tbody>
                                        <tr>
                                            <td><a href="detail-prestasi.php?hal=edit&kd=<?php echo $data['id'];?>"><span
                                                        class="fa fa-book"></span>
                                                    <?php echo $data['keterangan']; ?></a>
                                            </td>
                                            <td>
                                                <center><img src="gambar_prestasi/<?php echo $data['gambar_prestasi']; ?>" height="100"
                                                        width="100" style="border: 1px solid #333333;" />
                                                </center>
                                            </td>
                                            <td>
                                                <center>
                                                    <div id="thanks">
                                                        ...
                                                        <a class="delete-link" data-placement="bottom"
                                                            ...
                                                            href="hapus-prestasi.php?hal=hapus&kd=<?php echo $data['id'];?>"
              ...
              ?>
                            ...
                            <?php $tampil=mysql_query("select * from prestasi order by id");
                                  $prestasi=mysql_num_rows($tampil);
                            ?>
                            <center>
                                <h4>Jumlah Data : <?php echo "$prestasi"; ?> </h4>
                            </center>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <img id="edit-gambar_prestasi" height="150" width="150" class="img-circle"
    ...
    <script>
        //tambah kode script
        //modal tambah 
        $("#form_tambah_prestasi").submit(function (event) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == "sukses") {
                        ...
                        $('#edit-gambar_prestasi').attr("src","gambar_prestasi/" + data.data.gambar_prestasi);
        ...
        //modal edit save 
        $("#form_edit_prestasi").submit(function (event) {
            event.preventDefault();
            var formData = new FormData(this);
            console.log(formData);
