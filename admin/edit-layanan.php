                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Edit data layanan</center></b>

                                </header>
                                <!-- <div class="box-header"> -->
                                    <!-- <h3 class="box-title">Responsive Hover Table</h3> -->
                    <?php
                    $query = mysql_query("SELECT * FROM layanan WHERE id='$_GET[kd]'");
                    $data  = mysql_fetch_array($query);
                    ?>
                                <!-- </div> -->
                      <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-layanan.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                              <img src="gambar/<?php echo $data['g_layanan'];?>" height="150" width="150" class="img-circle" style="border: 3px solid darkblue;"/>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-6">
	                              ...
	                              <a href="layanan.php" class="btn btn-sm btn-danger">Batal </a>
