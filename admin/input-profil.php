                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center> Input Profil</center></b>

                      </header>
                      <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="upload-profil.php" method="POST" enctype="multipart/form-data">
                        
                        <div class="form-group">
                              <label class="col-sm-4 col-sm-4 control-label">Nama Perpustakaan</label>
                              <div class="col-sm-6">
                                  <input name="namaperpus" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="alamat" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="kec" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="kab" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="prov" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="nomor" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="webe" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="status" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="sk" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="tahun" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="npsn" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>

                          <div class="form-group">
                              <label class="col-sm-4 col-sm-4 control-label">Luas Tanah</label>
                              <div class="col-sm-6">
                                  <input name="luas" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="no_i" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="namaks" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="namakp" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <input name="nosk" type="text"  class="form-control" autocomplete="off" placeholder="" required="" />
                              </div>
                          </div>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input-ebook.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
                    </form>
                                </div>
