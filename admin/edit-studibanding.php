...
<?php } ?>
                ...
                <section class="content">
                    ...
                    ?>
                        ...
                        <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-studibanding.php" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kunjungan</label>
                              <div class="col-sm-2">
                              <select name="kunjungan" type="text" id="kunjungan" class="form-control" autocomplete="off" value="<?php echo $data['kunjungan']; ?>" required="">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                              <input name="keterangan" id="keterangan"  class="form-control" autocomplete="off" value="<?php echo $data['keterangan']; ?>" required=""/>
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                              <img src="gambar/<?php echo $data['gambar_studi'];?>" height="150" width="150" class="img-circle" style="border: 3px solid darkblue;"/>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input-studibanding.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
