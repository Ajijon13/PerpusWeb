...
<?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = mysql_query("SELECT * FROM tatatertib WHERE id='$_GET[kd]'");
                    $data  = mysql_fetch_array($query);
                    ?>
                                <!-- </div> -->
                      <div class="panel-body">
                      <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-tatatertib.php" method="POST" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tata Tertib</label>
                              <div class="col-sm-6">
                              <textarea name="t_tertib" id="t_tertib" style="height:300px" class="form-control"autocomplete="off"  required=""><?php echo $data['t_tertib']; ?></textarea>
                              </div>
                          </div>
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-6">
	                              ...
	                              <a href="tatatertib.php" class="btn btn-sm btn-danger">Batal </a>
