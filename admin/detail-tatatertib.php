                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                <header class="panel-heading">
                                    <b><center>Detail Tata Tertib</center></b>
                    ...
                    ?>
                      ...
                      <div class="form-group">
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                              <textarea style="height:300px"  class="form-control"autocomplete="off"  required=""><?php echo $tampil['t_tertib']; ?></textarea>
                              </div>
                          </div>

                          <div class="text-right">
                                <a href="tatatertib.php" class="btn btn-sm btn-warning">Kembali <i class="fa fa-arrow-circle-right"></i></a>
                            </div>  
                      </form>
                                </div>
                            </div><!-- /.box -->
